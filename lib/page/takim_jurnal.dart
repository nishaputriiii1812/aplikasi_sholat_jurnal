    ...
    return Scaffold(backgroundColor: Colors.lightBlueAccent,
      body: SafeArea(child: SingleChildScrollView(
              ...
              return GestureDetector(
                ...
                child: Container(
                  ...
                  child: Column(children: [
                    Text(
                      hariSngkt[index],style: TextStyle(color: Colors.white,),),
                    Text("${tanggalList[index]}",
                      style: TextStyle(
                        color: Colors.white,
                        fontWeight: FontWeight.bold,
                        fontSize: 18,
        ...
        Container(margin: EdgeInsets.symmetric(horizontal: 12,vertical: 12),
          ...
          child: Row(
            children: [Checkbox(value: shubuhSudah,
            onChanged: (v){
        ...
        Container(
          ...
          decoration: BoxDecoration(color: Colors.white,
            borderRadius: BorderRadius.circular(15),),
          child: Row(children: [Checkbox(value: dzuhurSudah,
            onChanged: (v){
        ...
        Container(margin: EdgeInsets.symmetric(horizontal: 12,vertical: 12),
          ...
          decoration: BoxDecoration(color: Colors.white,
            borderRadius: BorderRadius.circular(15),),
          child: Row(children: [
            Checkbox(value: asharSudah,
              onChanged: (v){
                setState((){asharSudah=v!;});},),
            Text("Ashar (15:15)"),
          ],
          ),
        ),
        Container(margin: EdgeInsets.symmetric(horizontal: 12,vertical: 12),
          ...
          decoration: BoxDecoration(color: Colors.white,
            borderRadius: BorderRadius.circular(15),),
          child: Row(children: [Checkbox(value: maghribSudah,
            onChanged: (v){
        ...
        Container(margin: EdgeInsets.symmetric(horizontal: 12,vertical: 12),
          ...
          child: Row(
            ...
            Checkbox(
              value: isyaSudah,
              onChanged: (v){
                setState((){isyaSudah=v!;});},),
            Text("Isya (19:25)"),],),),
        SizedBox(height: 8),
        Container(margin: EdgeInsets.symmetric(horizontal: 12),
          width: double.infinity,
          child: Text("Sunnah",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,),),),
        Container(margin: EdgeInsets.symmetric(horizontal: 12,vertical: 12),
          padding: EdgeInsets.all(10),
          decoration: BoxDecoration(color: Colors.white,
            borderRadius: BorderRadius.circular(15),),
          child: Row(children: [
            Checkbox(value: dhuhaSudah,
              onChanged: (v){
        ...
        Container(margin: EdgeInsets.symmetric(horizontal: 12,vertical: 12),
          ...
          decoration: BoxDecoration(color: Colors.white,
            borderRadius: BorderRadius.circular(15),),
          child: Row(children: [Checkbox(value: tahajjudSudah,
            onChanged: (v){
              setState((){tahajjudSudah=v!;});},),
            Text("Tahajud"),],),),
        SizedBox(height: 8),
        Container(margin: EdgeInsets.symmetric(horizontal: 5,vertical: 5),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [Text("Refleksi",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15,),),
              SizedBox(height: 6),
              TextField(controller: refleksiController,
                maxLines: 2,
              ...
              SizedBox(width: double.infinity,
                child: ElevatedButton(
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                        content: Text("Refleksi disimpan!")),);},
